...
export function getVecCoord(stream) {
...
export function encodeVecCoord(vector, stream) {
...
export function ParseBSPDecal(stream) {
    let modelIndex = 0;
    let entIndex = 0;
...
export function EncodeBSPDecal(packet, stream) {
