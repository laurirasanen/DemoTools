...
import { getClassBits, getSendTable } from '../../Data/ParserState';
...
export function ParsePacketEntities(stream, state, skip = false) {
...
export function EncodePacketEntities(packet, stream, state) {
