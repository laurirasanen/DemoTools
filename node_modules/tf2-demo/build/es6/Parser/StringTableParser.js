...
export function parseStringTableEntries(stream, table, entryCount, existingEntries = []) {
...
export function guessStringTableEntryLength(table, entries) {
...
export function encodeStringTableEntries(stream, table, entries, oldEntries = []) {
    const entryBits = logBase2(table.maxEntries);
    let lastIndex = -1;
    const history = [];
