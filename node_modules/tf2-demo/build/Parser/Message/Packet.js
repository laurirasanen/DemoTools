...
exports.PacketMessageHandler = {
        ...
        while (messageStream.bitsLeft > 6) {
            ...
            if (type !== 0) {
                ...
                if (handler) {
                    ...
                    console.log(`Unknown packet type ${type} just parsed a ${Packet_1.PacketTypeId[lastPacketType]}`);
                    return {
    ...
    encodeMessage: (message, stream, state, storedStates) => {
